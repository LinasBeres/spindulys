...
#define GUI_NAMESPACE_OPEN_SCOPE SPINDULYS_NAMESPACE_OPEN_SCOPE SPINDULYS_BASE_NAMESPACE_OPEN_SCOPE SPINDULYS_CPU_NAMESPACE_OPEN_SCOPE SPINDULYS_GUI_NAMESPACE_OPEN_SCOPE
